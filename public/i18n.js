...
const STRINGS = {
  de: {
    ...
    email: 'E-Mail', unlock: 'Entsperren', otherAccount: 'Anderes Konto',
    ...
    passwordTooShort: 'Passwort braucht mindestens 8 Zeichen', emailRequired: 'E-Mail-Adresse ist erforderlich', emailInvalid: 'Bitte eine gültige E-Mail-Adresse eingeben',
  ...
  en: {
    ...
    email: 'Email', unlock: 'Unlock', otherAccount: 'Different account',
    ...
    passwordTooShort: 'Password needs at least 8 characters', emailRequired: 'Email address is required', emailInvalid: 'Please enter a valid email address',
  ...
  es: {
    ...
    email: 'Correo', unlock: 'Desbloquear', otherAccount: 'Otra cuenta',
    ...
    passwordTooShort: 'La contraseña necesita al menos 8 caracteres', emailRequired: 'Se requiere una dirección de correo', emailInvalid: 'Introduce una dirección de correo válida',
  ...
  fr: {
    ...
    email: 'E-mail', unlock: 'Déverrouiller', otherAccount: 'Autre compte',
    ...
    passwordTooShort: 'Le mot de passe doit contenir au moins 8 caractères', emailRequired: 'Une adresse e-mail est requise', emailInvalid: 'Veuillez saisir une adresse e-mail valide',
