...
const q = {
  ...
  addOPK:       db.prepare('INSERT OR IGNORE INTO one_time_prekeys (device_id,opk_id,pub) VALUES (?,?,?)'),
  ...
  ktPutSTH:     db.prepare('INSERT OR REPLACE INTO kt_sths (size,root,ts,signature,cosigs) VALUES (?,?,?,?,?)'),
  ...
  addMember:    db.prepare('INSERT OR REPLACE INTO group_members (group_id,user_id,wrapped,is_admin) VALUES (?,?,?,?)'),
  ...
  /* ---- Kontaktabgleich ---- */
  putSelfHash:  db.prepare(`INSERT OR IGNORE INTO contact_hashes (user_id,hash,kind) VALUES (?,?,'self')`),
  putContactHash: db.prepare(`INSERT OR IGNORE INTO contact_hashes (user_id,hash,kind) VALUES (?,?,'contact')`),
  ...
  markNotified: db.prepare('INSERT OR IGNORE INTO contact_matches_notified (user_id,matched_id,notified_at) VALUES (?,?,?)'),
